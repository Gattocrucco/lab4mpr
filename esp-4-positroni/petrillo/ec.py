...
cos_theta = distance_2 / np.sqrt(distance_1 ** 2 + radius ** 2)
...
ratios['p_beta12_tot/p_beta12'] = ratios['p_beta1_tot/p_beta1'] + ratios['p_beta2_tot/p_beta2'] + ratios['p_beta1_tot/p_beta1'] * ratios['p_beta2_tot/p_beta2'] + 1
