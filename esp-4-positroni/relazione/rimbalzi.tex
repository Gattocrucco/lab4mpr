...
Guardando lo spettro 2D delle misure in coincidenza
abbiamo notato dei picchi non attesi che abbiamo supposto e poi verificato
essere dei fotoni che rimbalzano da un rivelatore all'altro.
...
A sinistra: misura eseguita nella configurazione di Figura\autoref{spostati}. \\
...
% \label{no_ce}
% }
\includegraphics[width=\textwidth]{immagini/rimb} % script: petrillo/rimb.py
\caption{\label{ce}
