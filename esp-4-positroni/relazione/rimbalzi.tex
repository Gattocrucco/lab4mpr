...
Le strutture non attese sono i due eccessi presenti nella zona in cui il fotone del neon e quello dell'annichilazione fanno entrambi scattering Compton. Queste strutture si manifestano a valori di energia coincidenti al cosiddetto backscattering e alla spalla Compton.
...
L'istogramma 2D corrispondente si trova in \autoref{spostato} sinistra: la struttura più densamente popolata non è più data dalla rivelazione simultanea dell'annichilazione per effetto fotoelettrico, ma dalla somma degli eventi in cui un solo PMT rivela un fotone di annichilazione.
...
\begin{figure}[h]
	...
	A destra: grafico raffigurante la differenza tra i due istogrammi.\\
