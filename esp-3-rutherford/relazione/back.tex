...
\marginpar{Su quella pagina c'è scritto che l'alluminio
viene fatto passivare di forza fino a strati di 50--\si{200}{nm}.
Inoltre non stiamo trascurando la diffusione Rutherford in quello strato,
bensì il fatto che ci siano ossigeni in giro e che la densità è un po' diversa
(quindi la differenza mi aspetto sia minore che se dovessi non considerarlo del tutto).}
