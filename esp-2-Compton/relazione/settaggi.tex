...
\begin{equation}
	\label{eq:scalibur}
	\left. \pdv{m_e}{E'} \right|_\theta = \frac{m_e}{E - E'}
\end{equation}
...
Ad esempio per $E=\SI{1.33}{MeV}$ e $\theta=\SI{10}{\degree}$ abbiamo $E-E'\approx\SI{51}{keV}$ e,
...
\begin{align*}
	\Delta m_e
	\approx \frac{m_e}{E - E'} \cdot \frac{\Delta E'}{E'} \cdot E'
	\approx \frac{\SI{511}{keV}}{\SI{51}{keV}} \cdot \SI1\% \cdot \SI{1.28}{MeV}
	= \SI{128}{keV}.
\end{align*}
