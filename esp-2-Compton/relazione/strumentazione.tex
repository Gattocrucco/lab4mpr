...
L'angolo di scattering ovvero l'angolo tra la direzione del fascio di fotoni primari e i fotoni secondi prodotti è misurato come mostrato in \autoref{fig:goniometro}: abbiamo stampato un goniometro su carta e lo abbiamo  sotto la base ruotante del PMT2 in modo che il centro fosse nel perno di rotazione che lo 0 fosse circa lungo la direzione del fascio primario. Una tacca sulla base trasparente ci consente di leggere l'angolo. Questa soluzione ci permette di misurare gli angoli con grande comodità e precisione (stimiamo di avere una risoluzione migliore di $\sfrac14 \si{\degree}$).
