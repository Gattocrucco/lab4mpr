...
\marginpar{Aggiungere tutti i link alle tabelle di dati, e usare i millivolt anziché i decimillivolt.} e tre lastre in coincidenza ($a$, $b$ e $c$) per misurare le efficienze di $A$ e $B$
...
\marginpar{Falso, ci sono misure in cui $B$ è fuori (PM6).}
...
\marginpar{Fare i grafici dei residui.}
