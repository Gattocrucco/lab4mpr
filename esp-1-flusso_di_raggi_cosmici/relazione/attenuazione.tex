...
\marginpar{Bisogna modificare la \autoref{4atte} in modo che si capisca anche in scala di grigi (usare marker più grossi con \texttt{markersize=...}).}
...
MODIFICA: sfasare un po' orizzontalmente le serie.}
\label{rig}
\end{figure}
