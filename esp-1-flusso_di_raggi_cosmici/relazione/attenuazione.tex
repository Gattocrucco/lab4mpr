...
\marginpar{Bisogna modificare la \autoref{4atte} in modo che si capisca anche in scala di grigi.}
...
\marginpar{Hai fatto la media pesata con $1/\sigma^2$?
O hai usato tutta la matrice di convarianza?
$\langle\mathbf{a}\rangle=(\sum_i V_i^{-1})^{-1}(\sum_i V_i^{-1}\mathbf a_i)$ \\ 
\emph{Risposta:  media pesata con $1/\sigma^2$.}}
...
\marginpar{Non abbiamo usato la distribuzione di Landau,
abbiamo semplicemente preso la moda dai nostri dati senza imporre niente sulla distribuzione.}
