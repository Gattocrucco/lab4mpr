...
\emph{1. In questo grafico le barre d'errore mi sembrano la deviazione standard
anziché la deviazione standard sulla media;
2. Poiché la Landau non ha media definita e inoltre stiamo troncando l'istogramma,
credo sia meglio utilizzare la moda campione (come consigliato sul PDG).}\\
Ho visto che hai calcolato la moda in modo discreto,
visto che abbiamo poco riempimento (meno dati dei valori possibili),
non è meglio calcolarla con un istogramma?}
\begin{figure}[h]
\centering
