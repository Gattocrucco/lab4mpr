...
Abbiamo sostituito il fattore pre-esponenziale $N_0$ della funzione \eqref{exp} con $V_0$ perché abbiamo dei valori in \si{mV} in ordinata. Il punto più a sinistra (vedi \autoref{col}) non è stato considerato nel fit perché palesemente lontano dall'andamento esponenziale seguito dagli altri punti. I parametri restituiti dal fit sono: $V_0=\SI{199\pm1}{mV}$, $\lambda=\SI{810\pm263}{cm}$, corr$(V_0,\lambda)=-0.93$, $\chi^2=8\pm1$ con dof=2. La lunghezza di attenuazione non è compatibile con entrambi i fit eseguiti precedentemente.
