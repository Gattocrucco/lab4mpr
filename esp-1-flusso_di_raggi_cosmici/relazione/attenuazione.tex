...
\marginpar{Non sapevo che altro metterci. Si accettano consigli in merito. Proverò a mettere la semilarghezza del bin.\\
\emph{È chiaro che la larghezza del bin ha molto più senso della digitalizzazione dell'ADC.}}. 
...
\marginpar{\emph{Secondo me il fit non ha senso neanche sui tre punti a destra.
Infatti guardando \autoref{rig} suppongo che facendo la media solo di alcune delle quattro curve
si possano ottenere altri andamenti, quindi il fit dipende molto da quali punti ci mettiamo.
Inoltre se come errore metti la semilarghezza del bin, forse l'andamento diventa palesemente casuale.}}
...
\marginpar{forse potevamo fittare solo i 3 punti più a destra della riga gialla, ma penso che non ne valga la pena}
\begin{figure}[h]
\centering
